...
@Component({
  selector: 'app-home-page-other-apps',
  templateUrl: './home-page-other-apps.component.html',
  styleUrls: ['./home-page-other-apps.component.css']
})
export class HomePageOtherAppsComponent implements OnInit {
