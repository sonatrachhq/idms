...
public void setINTERIMENDDATE(Date iNTERIMENDDATE) {
	...
	public ProcResult(Integer iDUSERIDMS, Integer iDROLE, Integer iDSTATUS, String dESCROLE, Date pRIVSTARTDATE,
		...
		String aPPLICATIONDETAIL, String iCONURL, Integer aPPLICATIONMODE, String aPPLICATIONURL, Integer pUBLICFLAG,
		Integer iEFLAG, Date iNTERIMSTARTDATE, Date iNTERIMENDDATE) {
	super();
